          ...
          <div class="col-12">
            <nav class="navbar navbar-expand-lg">
              <div class="container-fluid"> 
                <a style= width:7vw class="navbar-brand" href="#"><img src="image/Screenshot_191-semfundo.png" class="img-fluid img_logo" alt="..." ></a>
    ...
    <div class="container-fluid container_pginicial">
      <div class="row">
        <div class="col-lg-2 col-md-4 col-sm-5 col-xs-1 foto_perfil">
          <img src="image/perfil.jpg" class="rounded d-block" alt="..." style="width: 8rem"> 
          </BR></BR>
          <ul class="list-group">
            <div class="container">
              <div class="row">
        ...
        <!-- 1º CARD-->
          ...
          <div class="col-lg-3 col-sm-6">    
            <div class="card" style="width: 15rem;">
              <img src="image/jamesbar.jpeg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card" style="width: 15rem;">
              <img src="image/estar.png" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card" style="width: 15rem;">
              <img src="image/uniopet.png" class="card-img-top" alt="...">
              <div class="card-body">
                  ...
                  <div id="jamesmodal_carosel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item">
                        <img src="image/jamescardapio.jpg" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item active">
                        <img src="image/jamesbarbar.jpeg" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="image/jamesbarcardapio.jpeg" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="image/jamesbemloco.jpeg" class="d-block w-100" alt="...">
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div id="fundamentosModal_carosel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="image/FunTI_Slide1.png" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="image/FunTI_Slide2.png" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="image/FunTI_Slide3.png" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="image/FunTI_Slide4.png" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="image/FunTI_Slide5.png" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="image/FunTI_Slide6.png" class="d-block w-100" alt="...">
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="ratio ratio-16x9">
                    ...
                    <h3>Modelo OSI</h3>
                    <img src="image/Modelo_OSI.png" class="d-block w-100" alt="...">
                  </br></br>
                    ...
                    <p>
                      ...
                      <img src="image/NAT.png" class="d-block w-100" alt="...">
                    </p>
                  </br></br>
              ...
              <div class="row">
                <div class="col-12">
                  <div id="fundamentosModal_carosel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="image/estar.png" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="image/d78861017f898bc898b9ec525a7c7dff.jpg" class="d-block w-100" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="image/ajuda-negocios-sociais.webp" class="d-block w-100" alt="...">
                      </div>
