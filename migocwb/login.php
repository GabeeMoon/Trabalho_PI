...
<body>
    <div class="main-login">
        <div class="left-login">
            ...
            <img pclass="left-login-image"src="image/Screenshot_191-semfundo.png" alt="">
        </div>
            ...
            <div class="modal-header">
                <form action="index.php" method="post" class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="email" class="form-control" id="inputAddress" placeholder="email@email.com.br">
                    </div>
                    <div class="col-12">
